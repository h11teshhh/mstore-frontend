...
import '../utils/app_constants.dart'; // Ensure standard colors
...
class _CreateCustomerScreenState extends State<CreateCustomerScreen> {
  ...
  // Controller for the manual input (Hidden unless "Other" is selected)
  final TextEditingController manualAreaController = TextEditingController();

  // Controller just for displaying the selected value in the dropdown box
  final TextEditingController dropdownDisplayController =
      TextEditingController();

  bool loading = false;
  bool _isOtherSelected = false; // Tracks if "Other" is active
                    ...
                    return ListTile(
                      ...
                      onTap: () {
                        setState(() {
                          ...
                          // If "Other" is picked, enable the manual input field
                          _isOtherSelected = (item == "Other");
                          if (!_isOtherSelected) {
                            manualAreaController
                                .clear(); // Clear manual input if not needed
                          }
                        });
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // AREA SELECTOR (Trigger for Drawer)
                              GestureDetector(
                              ...
                              // CONDITIONAL: MANUAL INPUT (If "Other" is selected)
                              if (_isOtherSelected) ...[
                                const SizedBox(height: 16),
                                AnimatedOpacity(
